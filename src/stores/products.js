...
export const useProductsStore = defineStore("products", {
    ...
    actions: {
        ...
        filterProducts(index, filterNumb) {

            if (filterNumb == 'category') {
                switch (index) {
                    ...
                    case "4":
                        this.loadProducts();
                        this.products = this.products.filter((product) => product.category === "Single Serve");
                        break;
            ...
            if (filterNumb == 'cost') {
                switch (index) {
                    case "0":
                        this.loadProducts();
                        this.products = this.products.filter((item) =>  item.price < 20);
                        break;
                    case "1":
                        this.loadProducts();
                        this.products = this.products.filter((item) =>  item.price < 30);
                        break;
                    case "2":
                        this.loadProducts();
                        this.products = this.products.filter((item) =>  item.price < 40);
                        break;
                    case "3":
                        this.loadProducts();
                        this.products = this.products.filter((item) =>  item.price < 50);
                        break;
                }
            }
