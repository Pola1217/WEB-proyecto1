  ...
  async rateProduct() {
    if (this.authenticationStore.getUser() !== null) {
      ...
      if (!user.rating || !user.rating.includes(this.currentProduct.id) && this.rating !== null) {
        ...
        this.firestoreStore.addUserRating(uid, this.userRatings(user));

        this.firestoreStore.addProductRating(this.currentProduct.id, this.productRating(this.currentProduct));
